    ...
    exports.btnEdit = function () {
        ...
        if (checkedRow(keyValue)) {
            $.fn.modalOpen({
                ...
                url: '/admin/task/createtask/' + keyValue,
                width: "550px",
                height: "480px",
    ...
    exports.loadGrid = function () {
        ...
        exports.options.$gridTable.jqGrid({
            ...
            colModel: [
                ...
                { label: "任务名称", name: "task_name", index: "task_name", width: 150, align: "left" },
                { label: "任务分组", name: "task_group", index: "task_group", width: 150, align: "center" },
                { label: "任务类型", name: "task_type", index: "task_type", width: 70, align: "center" },
                {
                    label: "执行状态", name: "task_status", index: "task_status", width: 70, align: "center",
                    formatter: function (cellvalue, options, rowObject) {
                        var index = rowObject["task_status"];
                        var className = exports.options.TaskStatusTypes[index];
                        return '<span class="label ' + className + '">' + cellvalue + '</span>';
                    }
                },
                { label: "执行频率", name: "interval", index: "interval", width: 200, align: "left" },
                { label: "URL", name: "interfaceurl", index: "interfaceurl", width: 150, align: "center" },
                { label: "程序集", name: "service_code", index: "service_code", width: 150, align: "left" },
                { label: "类名", name: "interface_code", index: "interface_code", width: 150, align: "center" },
                {
                    label: "下次运行时间", name: "nextexectuetime", index: "nextexectuetime", width: 150, align: "left",
                    formatter: function (cellvalue, options, rowObject) {
                        return formatDate(cellvalue, 'yyyy-MM-dd hh:mm:ss');
                    }
                },
                {
                    label: "创建时间", name: "create_date", index: "create_date", width: 150, align: "left",
                    formatter: function (cellvalue, options, rowObject) {
                        return formatDate(cellvalue, 'yyyy-MM-dd hh:mm:ss');
                    }
                },
